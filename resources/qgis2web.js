...
map.getView().fit([-8343333.094207, -2731191.285512, -6181394.029517, -995078.189367], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Estaciones meteorológicas de  Bolivia</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (168 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ubicación de estaciones meteorológicas del SENAMHI–Bolivia, procesadas y estandarizadas en QGIS para el trabajo de la materia SIG de la Maestría en Ciencias Geomáticas.';
            }
